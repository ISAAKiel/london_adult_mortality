...
London_1728_1840 <- data.frame(source = "London 1728-1840", london_1728_1840_result[which(london_1728_1840_result$parameter == "M"),c(1,7)])
London_1728_1840_r <- data.frame(source = "London 1728-1840", london_1728_1840_result_r[which(london_1728_1840_result_r$parameter == "M"),c(1,7)])
english_mortality <- rbind(england, London_1728_1840, London_1841, HMD_UK)
...
english_mortality_prep <- rbind(Peers_prep, monks_prep, english_mortality_prep)
english_mortality_r <- rbind(england, London_1728_1840_r, London_1841, HMD_UK)
english_mortality_prep_r <- data.frame(source = "written", data = english_mortality_r$source, 
                                     M = english_mortality_r$Mode, year = english_mortality_r$year,
                                     start = NA, end = NA, HDIlow = NA, HDIhigh = NA)
english_mortality_prep_r <- rbind(Peers_prep, monks_prep, english_mortality_prep_r)
