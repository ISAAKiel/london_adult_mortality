...
date <- c(1200, 1300, 1350, 1500, 1550, 1600, 1650, 1695, 1730, 1740, 1750, 1760, 1770, 1780, 1790, 1801, 1811, 1821, 1831, 1841, 1851, 1861)
size <- c(22500, 90000, 37500, 75000, 120000, 200000, 375000, 527560, 660000, 670000, 680000, 730000, 780000, 820000, 910000, 1090078, 1294765, 1560419, 1862970, 2185804, 2630782, 3155114)

date_diff <- date[-1] - date[-length(date)]
size_diff <- size[-1] / size[-length(size)]
rate <- 10^(log10(size_diff) / date_diff)
year_date <- cumsum(date_diff) + 1200
