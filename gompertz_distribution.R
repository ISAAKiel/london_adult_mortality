gridExtra::grid.arrange (
  ...
  ggplot() + xlim(15, 105) + ylim(0, 1) +
    geom_function(fun = function(x) gomp_lx(x - 15, exp((-66.77) * (0.025 - 0.0718) - 7.119), 0.025),
                  aes(col = "\u03B2 = 0.025")) +
    geom_function(fun = function(x) gomp_lx(x - 15,  exp((-66.77) * (0.04 - 0.0718) - 7.119), 0.04), 
                  aes(col = "\u03B2 = 0.04")) +
    geom_function(fun = function(x) gomp_lx(x - 15,  exp((-66.77) * (0.06 - 0.0718) - 7.119), 0.06), 
                  aes(col = "\u03B2 = 0.06")) +
    geom_function(fun = function(x) gomp_lx(x - 15,  exp((-66.77) * (0.09 - 0.0718) - 7.119), 0.09), 
                  aes(col = "\u03B2 = 0.09")) +
