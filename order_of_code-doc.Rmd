...
The data is referenced and aggregated in "./chapter_04_results/historical_lifetables.R". In this file, all records from individual preprocessing files located in "./liftables_preprocessed/" are ```sourced```.  The corresponding file names are given in brackets (note: due to LaTeX problems, underscores are replaced by spaces).

```{r Tables with basic statistics of the preprocessed data, warning=FALSE}
source("./chapter_04_results/historical_lifetables.R")
kable(peers_ranges, 
      caption = "English Peers (English Peers.R)")
kable(monks_ranges, 
