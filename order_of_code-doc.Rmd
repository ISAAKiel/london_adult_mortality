...
English_Peers.R, russell.txt, ```r read.delim("./data/russell.txt", sep = "|", header = F, nrows = 1)[1,1]```
...
Medieval_England.R, Christ_church_monks.txt, ```r read.delim("./data/Christ_church_monks.txt", sep = "|", header = F, nrows = 1)[1,1]```
...
London_1728_1840.R, Mortality_bills_1728_1840.txt, ```r read.delim("./data/Mortality_bills_1728_1840.txt", sep = "|", header = F, nrows = 1)[1,1]```
...
London_1841_raw_all.R, London_1841_raw.txt, ```r read.delim("./data/London_1841_raw.txt", sep = "|", header = F, nrows = 1)[1,1]```

```{r Basic statistics census data for London from 1841, warning=FALSE}
kable(London_1841_ranges, 
      caption = "census data for London from 1841, range of rate") %>%
  kable_styling(latex_options = "HOLD_position")
```

English_Mortality.R, wrigley_et_al_1997_england_1640-1809.txt, ```r read.delim("./data/wrigley_et_al_1997_england_1640-1809.txt", sep = "|", header = F, nrows = 1)[1,1]```
